                    ...
                    if (CellID == 0)
                    {
                        if (ShopID == 0)
                        {
                            ...
                            else
                            {
                                ...
                                try
                                {
                                    obj.deletetbloeedashboardvariablestodaysDetails2(ipAddress);
                                ...
                                try
                                {
                                    obj.deletetbloeedashboardfinalvariablesDetails2(ipAddress);
                    ...
                    if (OEEDataSummarizedToView != null)
                    {
                        ...
                        if (TimingVar != "Today")
                        {
                            GetDistinctLossQuery = "Select Distinct f.lossname from" +
                                                     "(" +
                                                     "Select Distinct a.Loss1Name as lossname from i_facility_tsal.dbo.tbloeedashboardvariables a where CellID = " + CellID + "  and StartDate Between '" + frmDate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + toDate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                                     "Union All " +
                                                     "Select Distinct b.Loss2Name  as lossname from i_facility_tsal.dbo.tbloeedashboardvariables b where CellID = " + CellID + "  and StartDate Between '" + frmDate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + toDate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                                     "Union All " +
                                                     "Select Distinct c.Loss3Name as lossname from i_facility_tsal.dbo.tbloeedashboardvariables c where CellID = " + CellID + "  and StartDate Between '" + frmDate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + toDate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                                     "Union All " +
                                                     "Select Distinct d.Loss4Name as lossname from i_facility_tsal.dbo.tbloeedashboardvariables d where CellID = " + CellID + "  and StartDate Between '" + frmDate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + toDate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                                     "Union All " +
                                                     "Select Distinct e.Loss5Name as lossname from i_facility_tsal.dbo.tbloeedashboardvariables e where CellID = " + CellID + "  and StartDate Between '" + frmDate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + toDate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                        ...
                        else
                        {
                            GetDistinctLossQuery = "Select Distinct f.lossname from" +
                                                     "(" +
                                                     "Select Distinct a.Loss1Name as lossname from i_facility_tsal.dbo.tbloeedashboardvariablestoday a where CellID = " + CellID + " and IPAddress = '" + ipAddress + "' and StartDate Between '" + frmDate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + toDate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                                     "Union All " +
                                                     "Select Distinct b.Loss2Name  as lossname from i_facility_tsal.dbo.tbloeedashboardvariablestoday b where CellID = " + CellID + " and IPAddress = '" + ipAddress + "' and StartDate Between '" + frmDate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + toDate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                                     "Union All " +
                                                     "Select Distinct c.Loss3Name as lossname from i_facility_tsal.dbo.tbloeedashboardvariablestoday c where CellID = " + CellID + " and IPAddress = '" + ipAddress + "' and StartDate Between '" + frmDate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + toDate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                                     "Union All " +
                                                     "Select Distinct d.Loss4Name as lossname from i_facility_tsal.dbo.tbloeedashboardvariablestoday d where CellID = " + CellID + " and IPAddress = '" + ipAddress + "' and StartDate Between '" + frmDate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + toDate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                                     "Union All " +
                                                     "Select Distinct e.Loss5Name as lossname from i_facility_tsal.dbo.tbloeedashboardvariablestoday e where CellID = " + CellID + " and IPAddress = '" + ipAddress + "' and StartDate Between '" + frmDate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + toDate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                                     ") f order by f.lossname desc";
                        }
                ...
                if (lowestLevel == "Shop")
                {
                    ...
                    if (OEEDataSummarizedToViewShop != null)
                    {
                        ...
                        if (TimingVar != "Today")
                        {
                            GetDistinctLossQuery = "Select Distinct f.lossname from" +
                                                 "(" +
                                                 "Select Distinct a.Loss1Name as lossname from i_facility_tsal.dbo.tbloeedashboardvariables a where ShopID = " + ShopID + " and StartDate Between '" + frmDate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + toDate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                                 "Union All " +
                                                 "Select Distinct b.Loss2Name  as lossname from i_facility_tsal.dbo.tbloeedashboardvariables b where ShopID = " + ShopID + " and StartDate Between '" + frmDate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + toDate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                                 "Union All " +
                                                 "Select Distinct c.Loss3Name as lossname from i_facility_tsal.dbo.tbloeedashboardvariables c where ShopID = " + ShopID + " and StartDate Between '" + frmDate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + toDate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                                 "Union All " +
                                                 "Select Distinct d.Loss4Name as lossname from i_facility_tsal.dbo.tbloeedashboardvariables d where ShopID = " + ShopID + " and StartDate Between '" + frmDate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + toDate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                                 "Union All " +
                                                 "Select Distinct e.Loss5Name as lossname from i_facility_tsal.dbo.tbloeedashboardvariables e where ShopID = " + ShopID + " and StartDate Between '" + frmDate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + toDate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                                 ") f order by f.lossname desc";
                        }
                        else
                        {
                            GetDistinctLossQuery = "Select Distinct f.lossname from" +
                                                "(" +
                                                "Select Distinct a.Loss1Name as lossname from i_facility_tsal.dbo.tbloeedashboardvariablestoday a where ShopID = " + ShopID + " and IPAddress = '" + ipAddress + "' and StartDate Between '" + frmDate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + toDate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                                "Union All " +
                                                "Select Distinct b.Loss2Name  as lossname from i_facility_tsal.dbo.tbloeedashboardvariablestoday b where ShopID = " + ShopID + " and IPAddress = '" + ipAddress + "' and StartDate Between '" + frmDate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + toDate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                                "Union All " +
                                                "Select Distinct c.Loss3Name as lossname from i_facility_tsal.dbo.tbloeedashboardvariablestoday c where ShopID = " + ShopID + " and IPAddress = '" + ipAddress + "' and StartDate Between '" + frmDate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + toDate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                                "Union All " +
                                                "Select Distinct d.Loss4Name as lossname from i_facility_tsal.dbo.tbloeedashboardvariablestoday d where ShopID = " + ShopID + " and IPAddress = '" + ipAddress + "' and StartDate Between '" + frmDate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + toDate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                                "Union All " +
                                                "Select Distinct e.Loss5Name as lossname from i_facility_tsal.dbo.tbloeedashboardvariablestoday e where ShopID = " + ShopID + " and IPAddress = '" + ipAddress + "' and StartDate Between '" + frmDate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + toDate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                                ") f order by f.lossname desc";
                        }
                        DataTable GetDistinctLossDT = new DataTable();
                        using (MsqlConnection mc = new MsqlConnection())
                        ...
                        if (OEEDataSummarizedToViewShop.Loss1Name != "")
                        {
                        ...
                        if (OEEDataSummarizedToViewShop.Loss2Name != "")
                        {
                        ...
                        if (OEEDataSummarizedToViewShop.Loss3Name != "")
                        {
                        ...
                        if (OEEDataSummarizedToViewShop.Loss4Name != "")
                        {
                        ...
                        if (OEEDataSummarizedToViewShop.Loss5Name != "")
                        {
            ...
            if (PlantID != 0)
            {
                if (CellID != 0)
                {
                    ...
                    if (WorkCenterID != 0)
                    {
                        ...
                        ViewBag.SelectedPath = plantName + " => " + shopName + " => " + cellName + " => " + wcName.MachineInvNo + " From: " + frmDate.ToString("yyyy-MM-dd") + " To: " + toDate.ToString("yyyy-MM-dd");
                        ViewData["WorkCenterID"] = new SelectList(obj.GetmachineList(PlantID, ShopID, WorkCenterID), "MachineID", "MachineInvNo");
                    ...
                    {
                        ViewBag.SelectedPath = plantName + " => " + shopName + " => " + cellName + " From: " + frmDate.ToString("yyyy-MM-dd") + " To: " + toDate.ToString("yyyy-MM-dd");
                        ViewData["WorkCenterID"] = new SelectList(obj.GetmachineList(PlantID, ShopID, WorkCenterID), "MachineID", "MachineInvNo");
                ...
                {
                    ViewBag.SelectedPath = plantName + " => " + shopName + " From: " + frmDate.ToString("yyyy-MM-dd") + " To: " + toDate.ToString("yyyy-MM-dd");
                    ViewData["CellID"] = new SelectList(obj.GetCellList1(ShopID, PlantID), "CellID", "CellName", CellID);
                    ...
                    if (WorkCenterID != 0)
                    {
                        var wcName = obj.GettbMachineDet(WorkCenterID);
                        //string wcName = db.tblmachinedetails.Where(m => m.IsDeleted == 0 && m.MachineID == WorkCenterID).Select(m => m.MachineInvNo).FirstOrDefault();
                        ViewBag.SelectedPath = plantName + " => " + shopName + " => " + wcName.MachineInvNo + " From: " + frmDate.ToString("yyyy-MM-dd") + " To: " + toDate.ToString("yyyy-MM-dd");
                        ViewData["WorkCenterID"] = new SelectList(obj.GetmachineList(PlantID, ShopID, WorkCenterID), "MachineID", "MachineInvNo");
                        //ViewData["WorkCenterID"] = new SelectList(db.tblmachinedetails.Where(m => m.IsDeleted == 0 && m.PlantID == PlantID && m.ShopID == ShopID && m.IsNormalWC == 0), "MachineID", "MachineInvNo");
                    }
                    else
        ...
        public void CalculateSummarizedOEEPlant(DateTime fromdate, DateTime todate, int FactorID, string TimeType, string SummarizeAs = null)
        {
            ...
            if (TimeType == "Today")
            {
                ...
                foreach (var PlantRow in getPlant)
                {
                    ...
                    string GetDistinctLossQuery = "Select Distinct f.lossname from" +
                                             "(" +
                                             "Select Distinct a.Loss1Name as lossname from i_facility_tsal.dbo.tbloeedashboardvariablestoday a where PlantID = " + PlantRow + " and IPAddress = '" + ipAddress + "' and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct b.Loss2Name  as lossname from i_facility_tsal.dbo.tbloeedashboardvariablestoday b where PlantID = " + PlantRow + " and IPAddress = '" + ipAddress + "' and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct c.Loss3Name as lossname from i_facility_tsal.dbo.tbloeedashboardvariablestoday c where PlantID = " + PlantRow + " and IPAddress = '" + ipAddress + "' and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct d.Loss4Name as lossname from i_facility_tsal.dbo.tbloeedashboardvariablestoday d where PlantID = " + PlantRow + " and IPAddress = '" + ipAddress + "' and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct e.Loss5Name as lossname from i_facility_tsal.dbo.tbloeedashboardvariablestoday e where PlantID = " + PlantRow + " and IPAddress = '" + ipAddress + "' and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             ") f order by f.lossname desc";
                    DataTable GetDistinctLossDT = new DataTable();
                    using (MsqlConnection mc = new MsqlConnection())
                    {
                    ...
                    for (int i = 0; i < LossCount; i++)
                    {
                        ...
                        String GetLossDurationQuery = "Select SUM(Total) From " +
                                       "(Select SUM(Loss1Value)  as Total From i_facility_tsal.dbo.tbloeedashboardvariablestoday " +
                                       "Where PlantID = " + PlantRow + " and IPAddress = '" + ipAddress + "' and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND Loss1Name = '" + LossName + "'  " +
                                       "Union all " +
                                       "Select SUM(Loss2Value)  as Total From i_facility_tsal.dbo.tbloeedashboardvariablestoday  " +
                                       "Where PlantID = " + PlantRow + " and IPAddress = '" + ipAddress + "' and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND Loss2Name = '" + LossName + "'  " +
                                       "Union All " +
                                       "Select SUM(Loss3Value)  as Total From i_facility_tsal.dbo.tbloeedashboardvariablestoday  " +
                                       "Where PlantID = " + PlantRow + " and IPAddress = '" + ipAddress + "' and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND Loss3Name = '" + LossName + "' " +
                                       "Union All " +
                                       "Select SUM(Loss4Value)  as Total From i_facility_tsal.dbo.tbloeedashboardvariablestoday  " +
                                       "Where PlantID = " + PlantRow + " and IPAddress = '" + ipAddress + "' and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND Loss4Name = '" + LossName + "' " +
                                       "Union All " +
                                       "Select SUM(Loss5Value)  as Total From i_facility_tsal.dbo.tbloeedashboardvariablestoday " +
                                       "Where PlantID = " + PlantRow + " and IPAddress = '" + ipAddress + "' and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND Loss5Name = '" + LossName + "' " +
                                       ") z;";
            ...
            else if (TimeType == "GodHours" || TimeType == "NoBlue")
            {
                ...
                foreach (var PlantRow in getPlant)
                {
                    ...
                    string GetDistinctLossQuery = "Select Distinct f.lossname from" +
                                             "(" +
                                             "Select Distinct a.Loss1Name as lossname from i_facility_tsal.dbo.tbloeedashboardvariables a where PlantID = " + PlantRow + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct b.Loss2Name  as lossname from i_facility_tsal.dbo.tbloeedashboardvariables b where PlantID = " + PlantRow + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct c.Loss3Name as lossname from i_facility_tsal.dbo.tbloeedashboardvariables c where PlantID = " + PlantRow + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct d.Loss4Name as lossname from i_facility_tsal.dbo.tbloeedashboardvariables d where PlantID = " + PlantRow + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct e.Loss5Name as lossname from i_facility_tsal.dbo.tbloeedashboardvariables e where PlantID = " + PlantRow + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             ") f order by f.lossname desc";
                    DataTable GetDistinctLossDT = new DataTable();
                    using (MsqlConnection mc = new MsqlConnection())
                    {
                    ...
                    for (int i = 0; i < LossCount; i++)
                    {
                        ...
                        DataTable GetLossDurationDT = new DataTable();
                        String GetLossDurationQuery = "Select SUM(Total) From " +
                                       "(Select SUM(Loss1Value)  as Total From i_facility_tsal.dbo.tbloeedashboardvariables " +
                                       ...
                                       "Union all " +
                                       "Select SUM(Loss2Value)  as Total From i_facility_tsal.dbo.tbloeedashboardvariables  " +
                                       ...
                                       "Union All " +
                                       "Select SUM(Loss3Value)  as Total From i_facility_tsal.dbo.tbloeedashboardvariables  " +
                                       ...
                                       "Union All " +
                                       "Select SUM(Loss4Value)  as Total From i_facility_tsal.dbo.tbloeedashboardvariables  " +
                                       ...
                                       "Union All " +
                                       "Select SUM(Loss5Value)  as Total From i_facility_tsal.dbo.tbloeedashboardvariables " +
        ...
        public void CalculateSummarizedOEEShop(DateTime fromdate, DateTime todate, int FactorID, string TimeType, string SummarizeAs = null)
        {
            ...
            if (TimeType == "Today")
            {
                ...
                foreach (var ShopRow in getShop)
                {
                    ...
                    string GetDistinctLossQuery = "Select Distinct f.lossname from" +
                                             "(" +
                                             "Select Distinct a.Loss1Name as lossname from i_facility_tsal.dbo.tbloeedashboardvariablestoday a where ShopID = " + ShopRow + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct b.Loss2Name  as lossname from i_facility_tsal.dbo.tbloeedashboardvariablestoday b where ShopID = " + ShopRow + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct c.Loss3Name as lossname from i_facility_tsal.dbo.tbloeedashboardvariablestoday c where ShopID = " + ShopRow + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct d.Loss4Name as lossname from i_facility_tsal.dbo.tbloeedashboardvariablestoday d where ShopID = " + ShopRow + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct e.Loss5Name as lossname from i_facility_tsal.dbo.tbloeedashboardvariablestoday e where ShopID = " + ShopRow + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             ") f order by f.lossname desc";
                    DataTable GetDistinctLossDT = new DataTable();
                    using (MsqlConnection mc = new MsqlConnection())
                    {
                    ...
                    for (int i = 0; i < LossCount; i++)
                    {
                        ...
                        String GetLossDurationQuery = "Select SUM(Total) From " +
                                       "(Select SUM(Loss1Value)  as Total From i_facility_tsal.dbo.tbloeedashboardvariablestoday " +
                                       "Where ShopID = " + ShopRow + " and IPAddress = '" + ipAddress + "' and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND Loss1Name = '" + LossName + "'  " +
                                       "Union all " +
                                       "Select SUM(Loss2Value)  as Total From i_facility_tsal.dbo.tbloeedashboardvariablestoday  " +
                                       "Where ShopID = " + ShopRow + " and IPAddress = '" + ipAddress + "' and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND Loss2Name = '" + LossName + "'  " +
                                       "Union All " +
                                       "Select SUM(Loss3Value)  as Total From i_facility_tsal.dbo.tbloeedashboardvariablestoday  " +
                                       "Where ShopID = " + ShopRow + " and IPAddress = '" + ipAddress + "' and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND Loss3Name = '" + LossName + "' " +
                                       "Union All " +
                                       "Select SUM(Loss4Value)  as Total From i_facility_tsal.dbo.tbloeedashboardvariablestoday  " +
                                       "Where ShopID = " + ShopRow + " and IPAddress = '" + ipAddress + "' and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND Loss4Name = '" + LossName + "' " +
                                       "Union All " +
                                       "Select SUM(Loss5Value)  as Total From i_facility_tsal.dbo.tbloeedashboardvariablestoday " +
                                       "Where ShopID = " + ShopRow + " and IPAddress = '" + ipAddress + "' and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND Loss5Name = '" + LossName + "' " +
                                       ") z;";
                        DataTable GetLossDurationDT = new DataTable();
                        using (MsqlConnection mc = new MsqlConnection())
                        {
            ...
            else if (TimeType == "GodHours" || TimeType == "NoBlue")
            {
                ...
                foreach (var ShopRow in getShop)
                {
                    ...
                    string GetDistinctLossQuery = "Select Distinct f.lossname from" +
                                             "(" +
                                             "Select Distinct a.Loss1Name as lossname from i_facility_tsal.dbo.tbloeedashboardvariables a where ShopID = " + ShopRow + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct b.Loss2Name  as lossname from i_facility_tsal.dbo.tbloeedashboardvariables b where ShopID = " + ShopRow + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct c.Loss3Name as lossname from i_facility_tsal.dbo.tbloeedashboardvariables c where ShopID = " + ShopRow + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct d.Loss4Name as lossname from i_facility_tsal.dbo.tbloeedashboardvariables d where ShopID = " + ShopRow + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct e.Loss5Name as lossname from i_facility_tsal.dbo.tbloeedashboardvariables e where ShopID = " + ShopRow + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             ") f order by f.lossname desc";
        ...
        public void CalculateSummarizedOEECell(DateTime fromdate, DateTime todate, int FactorID, string TimeType, string SummarizeAs = null)
        {
            ...
            if (TimeType == "Today")
            {
                ...
                foreach (var CellRow in getCell)
                {
                    ...
                    string GetDistinctLossQuery = "Select Distinct f.lossname from" +
                                             "(" +
                                             "Select Distinct a.Loss1Name as lossname from i_facility_tsal.dbo.tbloeedashboardvariablestoday a where CellID = " + CellRow + " and IPAddress = '" + ipAddress + "' and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct b.Loss2Name  as lossname from i_facility_tsal.dbo.tbloeedashboardvariablestoday b where CellID = " + CellRow + " and IPAddress = '" + ipAddress + "' and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct c.Loss3Name as lossname from i_facility_tsal.dbo.tbloeedashboardvariablestoday c where CellID = " + CellRow + " and IPAddress = '" + ipAddress + "' and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct d.Loss4Name as lossname from i_facility_tsal.dbo.tbloeedashboardvariablestoday d where CellID = " + CellRow + " and IPAddress = '" + ipAddress + "' and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct e.Loss5Name as lossname from i_facility_tsal.dbo.tbloeedashboardvariablestoday e where CellID = " + CellRow + " and IPAddress = '" + ipAddress + "' and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             ") f order by f.lossname desc";
                    DataTable GetDistinctLossDT = new DataTable();
                    using (MsqlConnection mc = new MsqlConnection())
                    {
                    ...
                    for (int i = 0; i < LossCount; i++)
                    {
                        ...
                        String GetLossDurationQuery = "Select SUM(Total) From " +
                                       "(Select SUM(Loss1Value)  as Total From i_facility_tsal.dbo.tbloeedashboardvariablestoday " +
                                       "Where CellID = " + CellRow + " and IPAddress = '" + ipAddress + "' and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND Loss1Name = '" + LossName + "'  " +
                                       "Union all " +
                                       "Select SUM(Loss2Value)  as Total From i_facility_tsal.dbo.tbloeedashboardvariablestoday  " +
                                       "Where CellID = " + CellRow + " and IPAddress = '" + ipAddress + "' and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND Loss2Name = '" + LossName + "'  " +
                                       "Union All " +
                                       "Select SUM(Loss3Value)  as Total From i_facility_tsal.dbo.tbloeedashboardvariablestoday  " +
                                       "Where CellID = " + CellRow + " and IPAddress = '" + ipAddress + "' and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND Loss3Name = '" + LossName + "' " +
                                       "Union All " +
                                       "Select SUM(Loss4Value)  as Total From i_facility_tsal.dbo.tbloeedashboardvariablestoday  " +
                                       "Where CellID = " + CellRow + " and IPAddress = '" + ipAddress + "' and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND Loss4Name = '" + LossName + "' " +
                                       "Union All " +
                                       "Select SUM(Loss5Value)  as Total From i_facility_tsal.dbo.tbloeedashboardvariablestoday " +
                                       "Where CellID = " + CellRow + " and IPAddress = '" + ipAddress + "' and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND Loss5Name = '" + LossName + "' " +
                                       ") z;";
                        DataTable GetLossDurationDT = new DataTable();
                        using (MsqlConnection mc = new MsqlConnection())
                        {
            ...
            else if (TimeType == "GodHours" || TimeType == "NoBlue")
            {
                ...
                foreach (var CellRow in getCell)
                {
                    ...
                    string GetDistinctLossQuery = "Select Distinct f.lossname from" +
                                             "(" +
                                             "Select Distinct a.Loss1Name as lossname from i_facility_tsal.dbo.tbloeedashboardvariables a where CellID = " + CellRow + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct b.Loss2Name  as lossname from i_facility_tsal.dbo.tbloeedashboardvariables b where CellID = " + CellRow + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct c.Loss3Name as lossname from i_facility_tsal.dbo.tbloeedashboardvariables c where CellID = " + CellRow + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct d.Loss4Name as lossname from i_facility_tsal.dbo.tbloeedashboardvariables d where CellID = " + CellRow + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct e.Loss5Name as lossname from i_facility_tsal.dbo.tbloeedashboardvariables e where CellID = " + CellRow + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             ") f order by f.lossname desc";
                    DataTable GetDistinctLossDT = new DataTable();
                    using (MsqlConnection mc = new MsqlConnection())
                    {
                    ...
                    for (int i = 0; i < LossCount; i++)
                    {
                        ...
                        String GetLossDurationQuery = "Select SUM(Total) From " +
                                       "(Select SUM(Loss1Value)  as Total From i_facility_tsal.dbo.tbloeedashboardvariables " +
                                       "Where CellID = " + CellRow + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND Loss1Name = '" + LossName + "'  " +
                                       "Union all " +
                                       "Select SUM(Loss2Value)  as Total From i_facility_tsal.dbo.tbloeedashboardvariables  " +
                                       "Where CellID = " + CellRow + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND Loss2Name = '" + LossName + "'  " +
                                       "Union All " +
                                       "Select SUM(Loss3Value)  as Total From i_facility_tsal.dbo.tbloeedashboardvariables  " +
                                       "Where CellID = " + CellRow + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND Loss3Name = '" + LossName + "' " +
                                       "Union All " +
                                       "Select SUM(Loss4Value)  as Total From i_facility_tsal.dbo.tbloeedashboardvariables  " +
                                       "Where CellID = " + CellRow + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND Loss4Name = '" + LossName + "' " +
                                       "Union All " +
                                       "Select SUM(Loss5Value)  as Total From i_facility_tsal.dbo.tbloeedashboardvariables " +
                                       "Where CellID = " + CellRow + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND Loss5Name = '" + LossName + "' " +
                                       ") z;";
        ...
        public void CalculateSummarizedOEEWC(DateTime fromdate, DateTime todate, int FactorID, string TimeType, string SummarizeAs = null)
        {
            ...
            if (TimeType == "Today")
            {
                ...
                foreach (var WCRow in getWC)
                {
                    ...
                    string GetDistinctLossQuery = "Select Distinct f.lossname from" +
                                             "(" +
                                             "Select Distinct a.Loss1Name as lossname from i_facility_tsal.dbo.tbloeedashboardvariablestoday a where WCID = " + WCRow.WCID + " and IPAddress = '" + ipAddress + "' and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct b.Loss2Name  as lossname from i_facility_tsal.dbo.tbloeedashboardvariablestoday b where WCID = " + WCRow.WCID + " and IPAddress = '" + ipAddress + "'  and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct c.Loss3Name as lossname from i_facility_tsal.dbo.tbloeedashboardvariablestoday c where WCID = " + WCRow.WCID + " and IPAddress = '" + ipAddress + "'  and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct d.Loss4Name as lossname from i_facility_tsal.dbo.tbloeedashboardvariablestoday d where WCID = " + WCRow.WCID + " and IPAddress = '" + ipAddress + "'  and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct e.Loss5Name as lossname from i_facility_tsal.dbo.tbloeedashboardvariablestoday e where WCID = " + WCRow.WCID + " and IPAddress = '" + ipAddress + "'  and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             ") f order by f.lossname desc";
                    DataTable GetDistinctLossDT = new DataTable();
                    using (MsqlConnection mc = new MsqlConnection())
                    {
                    ...
                    for (int i = 0; i < LossCount; i++)
                    {
                        ...
                        String GetLossDurationQuery = "Select SUM(Total) From " +
                                       "(Select SUM(Loss1Value)  as Total From i_facility_tsal.dbo.tbloeedashboardvariablestoday " +
                                       "Where WCID = " + WCRow.WCID + " and IPAddress = '" + ipAddress + "' and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND Loss1Name = '" + LossName + "'  " +
                                       "Union all " +
                                       "Select SUM(Loss2Value)  as Total From i_facility_tsal.dbo.tbloeedashboardvariablestoday  " +
                                       "Where WCID = " + WCRow.WCID + " and IPAddress = '" + ipAddress + "' and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND Loss2Name = '" + LossName + "'  " +
                                       "Union All " +
                                       "Select SUM(Loss3Value)  as Total From i_facility_tsal.dbo.tbloeedashboardvariablestoday  " +
                                       "Where WCID = " + WCRow.WCID + " and IPAddress = '" + ipAddress + "' and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND Loss3Name = '" + LossName + "' " +
                                       "Union All " +
                                       "Select SUM(Loss4Value)  as Total From i_facility_tsal.dbo.tbloeedashboardvariablestoday  " +
                                       "Where WCID = " + WCRow.WCID + " and IPAddress = '" + ipAddress + "' and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND Loss4Name = '" + LossName + "' " +
                                       "Union All " +
                                       "Select SUM(Loss5Value)  as Total From i_facility_tsal.dbo.tbloeedashboardvariablestoday " +
                                       "Where WCID = " + WCRow.WCID + " and IPAddress = '" + ipAddress + "' and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND Loss5Name = '" + LossName + "' " +
                                       ") z;";
                    ...
                    using (MsqlConnection mcFinalInsertRows = new MsqlConnection())
                    {
                        ...
                        try
                        {
                            SqlCommand cmdFinalInsertRows = new SqlCommand("INSERT INTO tbloeedashboardfinalvariables(PlantID,ShopID,CellID,WCID,StartDate,EndDate,OEE,Availability,Performance,Quality,IsOverallShopWise,IsOverallCellWise,IsOverallWCWise,Loss1Name,Loss1Value,Loss2Name,Loss2Value,Loss3Name,Loss3Value,Loss4Name,Loss4Value,Loss5Name,Loss5Value,IPAddress,CreatedOn,CreatedBy,IsDeleted,IsToday)VALUES('" + Convert.ToInt32(PlantIDS) + "','" + Convert.ToInt32(ShopIDS) + "','" + Convert.ToInt32(CellIDS) + "','" + Convert.ToInt32(WCRow) + "','" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "','" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "','" + OEEFactor + "','" + AvaillabilityFactor + "','" + EfficiencyFactor + "','" + QualityFactor + "','" + isShopWise + "','" + isCellWise + "','" + isWCWise + "','" + lossCode1 + "','" + lossCodeVal1 + "','" + lossCode2 + "','" + lossCodeVal2 + "','" + lossCode3 + "','" + lossCodeVal3 + "','" + lossCode4 + "','" + lossCodeVal4 + "','" + lossCode5 + "','" + lossCodeVal5 + "','" + IPAddress + "','" + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + "','" + 1 + "','" + 0 + "','" + 1 + "');", mcFinalInsertRows.msqlConnection);
                            cmdFinalInsertRows.ExecuteNonQuery();
                        }
                        catch (Exception e)
                        {
            ...
            else if (TimeType == "GodHours" || TimeType == "NoBlue")
            {
                ...
                foreach (var WCRow in getWC)
                {
                    ...
                    /*     string GetDistinctLossQuery = "Select Distinct f.lossname from" +
                                                  "(" +
                                                  "Select Distinct a.Loss1Name as lossname from i_facility_tsal.dbo.tbloeedashboardvariables a where WCID = " + WCRow + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                                  "Union All " +
                                                  "Select Distinct b.Loss2Name  as lossname from i_facility_tsal.dbo.tbloeedashboardvariables b where WCID = " + WCRow + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                                  "Union All " +
                                                  "Select Distinct c.Loss3Name as lossname from i_facility_tsal.dbo.tbloeedashboardvariables c where WCID = " + WCRow + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                                  "Union All " +
                                                  "Select Distinct d.Loss4Name as lossname from i_facility_tsal.dbo.tbloeedashboardvariables d where WCID = " + WCRow + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                                  "Union All " +
                                                  "Select Distinct e.Loss5Name as lossname from i_facility_tsal.dbo.tbloeedashboardvariables e where WCID = " + WCRow + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                                  ") f order by f.lossname desc";*/
                    string GetDistinctLossQuery = "Select Distinct f.lossname from" +
                                             "(" +
                                             "Select Distinct a.Loss1Name as lossname from i_facility_tsal.dbo.tbloeedashboardvariables a where WCID = " + WCRow.WCID + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct b.Loss2Name  as lossname from i_facility_tsal.dbo.tbloeedashboardvariables b where WCID = " + WCRow.WCID + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct c.Loss3Name as lossname from i_facility_tsal.dbo.tbloeedashboardvariables c where WCID = " + WCRow.WCID + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct d.Loss4Name as lossname from i_facility_tsal.dbo.tbloeedashboardvariables d where WCID = " + WCRow.WCID + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct e.Loss5Name as lossname from i_facility_tsal.dbo.tbloeedashboardvariables e where WCID = " + WCRow.WCID + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             ") f order by f.lossname desc";
                    MsqlConnection mc = new MsqlConnection();
                    mc.open();
                    SqlDataAdapter GetDistinctLossDA = new SqlDataAdapter(GetDistinctLossQuery, mc.msqlConnection);
