   ...
   public class ReportsDao
    {
        ...
        public tbloeedashboardvariable GettbloeedashboardvariablesDet4(int MachineID, DateTime DateTimeValue)
        {
            ...
            try
            {
                string query = "SELECT * from [i_facility_TSAL].[dbo].tbloeedashboardvariables WHERE WCID =" + MachineID + " and StartDate = '" + DateTimeValue + "'";
        ...
        public List<int> GetmachineListfor1(int wcId)
        {
            ...
            try
            {
                string query = "SELECT MachineID From [i_facility_TSAL].[dbo].tblmachinedetails WHERE IsDeleted = 0 and IsNormalWC = 1 and ManualWCID = "+wcId+"";
                //det = _connectionFactory.GetConnection.QueryAsync<tblmachinedetail>(query).Result.ToList();
                det = lista.GetList(query, _connectionFactory.GetConnection);
                foreach (var item in det)
                {
        ...
        public decimal GettblworeportsDet3(int MachineID, string correctedDate,string ProdFAI)
        {
            ...
            try
            {
                string query = "SELECT Sum(MinorLoss) from [i_facility_TSAL].[dbo].tblworeport WHERE MachineID =" + MachineID+" and CorrectedDate ='"+correctedDate+"' and Type = '"+ProdFAI+"'";
                ddldet = lista.GetFirstOrDefault(query, _connectionFactory.GetConnection);
        ...
        public List<tblworeport> Gettblworeportfor1(int hmiid)
        {
            ...
            try
            {
                string query = "SELECT * From [i_facility_TSAL].[dbo].tblworeport WHERE HMIID =" + hmiid + " ";
                //det = _connectionFactory.GetConnection.QueryAsync<tblmachinedetail>(query).Result.ToList();
                det= lista.GetList(query, _connectionFactory.GetConnection);
            }
            catch (Exception ex)
        ...
        public List<tbldailyprodstatu> Gettbldailyprodstatusfor1(int MachineID,string CorrectedDate)
        {
            ...
            try
            {
                string query = "SELECT * From [i_facility_TSAL].[dbo].tbldailyprodstatu WHERE IsDeleted = 0 MachineID =" + MachineID+" and CorrectedDate = '"+CorrectedDate+ "' order by StartTime asc";
                //det = _connectionFactory.GetConnection.QueryAsync<tblmachinedetail>(query).Result.ToList();
                det= lista.GetList(query, _connectionFactory.GetConnection);
            }
            catch (Exception ex)
        ...
        public tbllossescode GettbloeelossDet3(string settingString)
        {
            ...
            try
            {
                string query = "SELECT * from [i_facility_TSAL].[dbo].tbllossescode WHERE IsDeleted =0 and  MessageType like '%" + settingString + "%'";
                ddldet = lista.GetFirstOrDefault(query, _connectionFactory.GetConnection);
            }
            catch (Exception ex)
            {
        ...
        public List<tblworeport> Gettblworeportfor2(int MachineID,string correctedDate)
        {
            ...
            try
            {
                string query = "SELECT * From [i_facility_TSAL].[dbo].tblworeport WHERE MachineID = " + MachineID+" and CorrectedDate ='"+correctedDate+ "'";
                //det = _connectionFactory.GetConnection.QueryAsync<tblmachinedetail>(query).Result.ToList();
                det= lista.GetList(query, _connectionFactory.GetConnection);
            }
            catch (Exception ex)
        ...
        public List<tblworeport> Gettblworeportfor2(string PartNoString,string WorkOrderNo,string OperationNoString)
        {
            ...
            try
            {
                string query = "SELECT * From [i_facility_TSAL].[dbo].tblworeport WHERE PartNo ='"+PartNoString+"' and WorkOrderNo ='"+WorkOrderNo+"' and OpNo ='"+OperationNoString+"' ";
                //det = _connectionFactory.GetConnection.QueryAsync<tblmachinedetail>(query).Result.ToList();
                det= lista.GetList(query, _connectionFactory.GetConnection);
            }
            catch (Exception ex)
        ...
        public tbluser GetuserDet3(int OperatorID)
        {
            ...
            try
            {
                string query = "SELECT * from [i_facility_TSAL].[dbo].tbluser WHERE UserID =" + OperatorID + "";
                ddldet = lista.GetFirstOrDefault(query, _connectionFactory.GetConnection);
            }
            catch (Exception ex)
            {
        ...
        public tblpartwiseworkcenter GettblpartwiseworkcenterDet3(int MachineIDRow)
        {
            ...
            try
            {
                string query = "SELECT * from [i_facility_TSAL].[dbo].tblpartwiseworkcenter WHERE WorkCenterId ="+MachineIDRow+"";
                ddldet = lista.GetFirstOrDefault(query, _connectionFactory.GetConnection);
            }
            catch (Exception ex)
            {
